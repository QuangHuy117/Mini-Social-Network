...
public class UserProfileServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = (String) siteMap.get(MyConstants.USER_PROFILE_FEATURE.USER_PROFILE_PAGE);
        ...
        try {
            ...
            if (dto != null) {
                ...
                List<ArticleDTO> listArticle = dao.getAllArticleByEmail(user.getEmail());
                request.setAttribute("LIST_ARTICLE_USER", listArticle);
                url = (String) siteMap.get(MyConstants.USER_PROFILE_FEATURE.USER_PROFILE_PAGE);
            }
